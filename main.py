...
import os
token = '7816936316:AAGjoio7u9ft5nBNYFZqlNo5nKGzU6z2paI' #bottoken
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '5462487835'
allowed_users = ['5462487835']  #Your ID
@bot.message_handler(commands=["start"])
def start(message):
    if str(message.chat.id) not in allowed_users:
        bot.reply_to(message, "🚫 𝐘𝐨𝐮 𝐜𝐚𝐧𝐧𝐨𝐭 𝐮𝐬𝐞 𝐭𝐡𝐞 𝐛𝐨𝐭 𝐭𝐨 𝐜𝐨𝐧𝐭𝐚𝐜𝐭 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐭𝐨 𝐩𝐮𝐫𝐜𝐡𝐚𝐬𝐞 𝐚 𝐛𝐨𝐭 𝐬𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧 @owner_hsu")
        return
    bot.reply_to(message, "𝐒𝐞𝐧𝐝 𝐭𝐡𝐞 𝐭𝐱𝐭 𝐟𝐢𝐥𝐞 𝐧𝐨𝐰")
@bot.message_handler(commands=["add"])
def add_user(message):
    if str(message.chat.id) == '5462487835':  # Only bot owner can add new users
        try:
...
def generate_code(message):
    if str(message.chat.id) == '5462487835':  # Only the bot owner can generate codes
...
𝐁𝐲 ➜ <a href='t.me/About_GSIX'>『ᝯׁhׁׅ֮ꪱׁׅtׁׅꪀׁׅᧁׁꫀׁׅܻ 』【𝐂𝐇】ᶜⁿꪜ 💤</a> ''', reply_markup=mes)
				msg = f'''
<a href=''>-</a> 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝐝 ✅
<a https://t.me/contact_adm1'>┏━━━━━━━━━━━⍟</a>			
<a https://t.me/contact_adm1'>┃</a>𝐂𝐂 <code>{cc}</code><a https://t.me/contact_adm1'>┗━━━━━━━⊛</a>
<a https://t.me/contact_adm1'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: 𝘚𝘛𝘙𝘐𝘗𝘌 𝘈𝘜𝘛𝘏 🟢 ⤾		
<a href='t.me/AboutGSIX'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: 𝘕𝘪𝘤𝘦! 𝘕𝘦𝘸 𝘱𝘢𝘺𝘮𝘦𝘯𝘵 𝘮𝘦𝘵𝘩𝘰𝘥 𝘢𝘥𝘥𝘦𝘥 ✅ ⤾

<a https://t.me/contact_adm1'>-</a> 𝐈𝐧𝐟𝐨: <code>{cc[:6]}-{card_type} - {brand}</code>
<a https://t.me/contact_adm1'>-</a> 𝐂𝐨𝐮𝐧𝐭𝐫𝐲: <code>{country} - {country_flag}</code>
<a https://t.me/contact_adm1'>-</a> 𝐁𝐚𝐧𝐤: <code>{bank}</code>

<a https://t.me/contact_adm1'>-</a> 𝐓𝐢𝐦𝐞: <code>{"{:.1f}".format(execution_time)} 𝐬𝐞𝐜𝐨𝐧𝐝</code> 
<a https://t.me/contact_adm1'>-</a> 𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: <a https://t.me/contact_adm1'>⏤͟͞𝑮𝑺𝑰𝑿 𓆩 𝑪𝑯𝑲 𓆪ꪾᶜⁿꪜ</a>'''
				print(last)
...
<a https://t.me/contact_adm1'>┃</a>𝐂𝐂 <code>{cc}</code><a https://t.me/contact_adm1'>┗━━━━━━━⊛</a>
<a https://t.me/contact_adm1'>-</a> 𝐆𝐚𝐭𝐞𝐰𝐚𝐲: 𝘚𝘛𝘙𝘐𝘗𝘌 𝘈𝘜𝘛𝘏 🟢 ⤾		
<a https://t.me/contact_adm1'>-</a> 𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: 𝘕𝘪𝘤𝘦! 𝘕𝘦𝘸 𝘱𝘢𝘺𝘮𝘦𝘯𝘵 𝘮𝘦𝘵𝘩𝘰𝘥 𝘢𝘥𝘥𝘦𝘥 ✅ ⤾
